Attribute VB_Name = "70_modRibbon"
...
' y el foco NO está dentro del subformulario subExport
...
' Visible solo cuando el contenedor subExport está Enabled = True
...
'==============================================================
' Limpieza de datos y Reinicio total
'==============================================================

'---------------------------------------------------------------
' Callback: Limpiar resultados (reset básico)
'---------------------------------------------------------------
...
'---------------------------------------------------------------
' Callback: Reiniciar motor (reset total)
'---------------------------------------------------------------
