Attribute VB_Name = "43_modExportExcel"

Option Compare Database
Option Explicit

'===============================================================
' Módulo: 43_modExportExcel
...
'---------------------------------------------------------------
Public Sub ExportarSimbolosNoUsadosExcel(cat As clsCatalogoInspector, ByVal ruta As String)
...
'---------------------------------------------------------------
Public Sub ExportarTodoAExcel(cat As clsCatalogoInspector, resultados As Collection, ByVal ruta As String)
    Dim xl As Object, wb As Object, ws As Object
    Dim fila As Long
    Dim r As clsResultadoAnalisis
    Dim sim As clsSimbolo
    ...
    ws.Cells(2, 2).Value = cat.Modulos.Count

    ws.Cells(3, 1).Value = "Clases"
    ws.Cells(3, 2).Value = cat.Clases.Count

    ws.Cells(4, 1).Value = "UserForms"
    ws.Cells(4, 2).Value = cat.UserForms.Count

    ws.Cells(5, 1).Value = "Formularios"
    ws.Cells(5, 2).Value = cat.Formularios.Count

    ws.Cells(6, 1).Value = "Informes"
    ws.Cells(6, 2).Value = cat.Informes.Count
