Attribute VB_Name = "44_modExportHTML"

Option Compare Database
Option Explicit

'===============================================================
' Módulo: 44_modExportHTML
...
'---------------------------------------------------------------
Public Sub ExportarTodoAHTML(cat As clsCatalogoInspector, resultados As Collection, ByVal ruta As String, estilo As EstiloHtml)
    ...
    Print #f, "<tr><td>Módulos estándar</td><td>" & cat.Modulos.Count & "</td></tr>"
    Print #f, "<tr><td>Clases</td><td>" & cat.Clases.Count & "</td></tr>"
    Print #f, "<tr><td>UserForms</td><td>" & cat.UserForms.Count & "</td></tr>"
    Print #f, "<tr><td>Formularios</td><td>" & cat.Formularios.Count & "</td></tr>"
    Print #f, "<tr><td>Informes</td><td>" & cat.Informes.Count & "</td></tr>"
    Print #f, "</table>"
