...
FROM tbmEquivNombre_3 INNER JOIN tbmEtimologiaNombres ON (tbmEquivNombre_3.NombreOriginal = tbmEtimologiaNombres.Nombre) AND (tbmEquivNombre_3.Genero = tbmEtimologiaNombres.Genero);
