...
Public Sub MF_MarcarTonicaPorIdioma( _
    ...
    Select Case UCase$(Abreviado)
        ...
        Case "ES"
            Call MF_MarcarTonicaES(Texto, esTonica)

        Case "EU"
            Call MF_MarcarTonicaEU(Texto, esTonica)

        Case "GL"
            Call MF_MarcarTonicaGL(Texto, esTonica)

        Case "CA"
            Call MF_MarcarTonicaCA(Texto, esTonica)

        Case "CA-VA"
            Call MF_MarcarTonicaCA_VA(Texto, esTonica)

        Case "CA-IB"
            Call MF_MarcarTonicaCA_IB(Texto, esTonica)

        Case "PT-EU"
            Call MF_MarcarTonicaPT_EU(Texto, esTonica)

        Case "PT-BR"
            Call MF_MarcarTonicaPT_BR(Texto, esTonica)

        Case "FR"
            Call MF_MarcarTonicaFR(Texto, esTonica)

        Case "EN-GB"
            Call MF_MarcarTonicaEN_GB(Texto, esTonica)
...
'
'        Case "ca-ib"
'            Call MF_SilabearAjustesCA_IB(Texto, Silabas)
'
'        Case "ca-va"
'            Call MF_SilabearAjustesCA_VA(Texto, Silabas)
'
'        ' --------------------------------------------------------
'        ' CASTELLANO / GALLEGO
'        ' --------------------------------------------------------
'        Case "es"
'            Call MF_SilabearAjustesES(Texto, Silabas)
'
'        Case "gl"
'            Call MF_SilabearAjustesGL(Texto, Silabas)
'
'        ' --------------------------------------------------------
'        ' EUSKARA
'        ' --------------------------------------------------------
'        Case "eu"
'            Call MF_SilabearAjustesEU(Texto, Silabas)
'
'        ' --------------------------------------------------------
'        ' PORTUGUÉS EUROPEO / BRASILEÑO
'        ' --------------------------------------------------------
'        Case "pt-eu"
'            Call MF_SilabearAjustesPT_EU(Texto, Silabas)
'
'        Case "pt-br"
'            Call MF_SilabearAjustesPT_BR(Texto, Silabas)
'
'        ' --------------------------------------------------------
'        ' FRANCÉS
'        ' --------------------------------------------------------
'        Case "fr"
'            Call MF_SilabearAjustesFR(Texto, Silabas)
'
'        ' --------------------------------------------------------
'        ' INGLÉS
'        ' --------------------------------------------------------
'        Case "en-gb"
'            Call MF_SilabearAjustesEN_GB(Texto, Silabas)
'
'
'    End Select
'
...
''' >>> INSERTAR ACENTO UNIVERSAL <<<
''If esTonica(i) And Not yaInsertadoAcento Then
''    RegistrarFonema col, "'", 61, NumOrden
''    NumOrden = NumOrden + 1
''    yaInsertadoAcento = True
''End If
'
...
'
'        Case "ES"   ' Castellano
'            Call MF_MarcarTonicaCastellano(Texto, esTonica)
'
'        Case "EU"   ' Euskara (acento penúltimo)
'            Call MF_MarcarTonicaEuskara(Texto, esTonica)
'
'        Case "GL"   ' Gallego
'            Call MF_MarcarTonicaGallego(Texto, esTonica)
'
''        Case "CA"   ' Catalán / Valenciano / Mallorquín
''            Call MF_MarcarTonicaCatalan(Texto, esTonica)
'
'        Case "CA" ' Catalán
'            Call MF_MarcarTonicaCatalan(Texto, esTonica)
'
'        Case "CA-VA" 'Valenciano
'            Call MF_MarcarTonicaValenciano(Texto, esTonica)
'
'        Case "CA-IB" 'Mallorquín
'            Call MF_MarcarTonicaMallorquin(Texto, esTonica)
'
'        Case "FR"   ' Francés (acento final)
'            Call MF_MarcarTonicaFrances(Texto, esTonica)
'
'        Case "EN"   ' Inglés (léxico)
'            Call MF_MarcarTonicaIngles(Texto, esTonica)
'
'        Case Else
'            ' Si no se reconoce el idioma, por defecto acento en la penúltima sílaba
'            Call MF_MarcarTonicaPenultima(Texto, esTonica)
'
'    End Select
'
