...
'    Else
'        T.Fisico = ReducirSimbolico(ConvertirLetraANumero(R.primeraLetra, f.sistemafonetico))
'    End If
...
'    Else
'        T.Mental = ReducirSimbolico(ConvertirLetraANumero(R.primeraVocal, f.sistemafonetico))
'    End If
...
'    Else
'        T.Emocional = ReducirSimbolico(ConvertirLetraANumero(R.primeraConsonante, f.sistemafonetico))
'    End If
...
'                sumaEspiritual = sumaEspiritual + ConvertirLetraANumero(letra, f.sistemafonetico)
'            End If
'        Next j
'    End If
'
...
'    Dim c2 As String
'
'    If D.sistemafonetico = Fonetico Then
'        '-----------------------------------------
