...
Public Function CargarFonetica(ByVal IDFonetica As Long) As clsFonetica
    ...
    If Not rs.EOF Then
        ...
        f.SistemaFonetico = rs!ModoFonetico
...
Public Function GuardarFonetica(ByVal f As clsFonetica) As Long
    ...
    rs!ModoFonetico = f.SistemaFonetico
...
Public Function ConfiguracionIgual(f As clsFonetica, FDB As clsFonetica) As Boolean
    If f.SistemaFonetico <> FDB.SistemaFonetico Then GoTo Diferente
...
'
'    ' --- Modo ---
'    Fonetica.sistemafonetico = IIf(frm!chkModoFon, 1, 0)
'
'    ' --- Reglas ---
...
'
'    ' --- Resultados fonéticos ---
'    Fonetica.FonNombre = MotorFonetico_Convertir(frm!txtNombre, Fonetica.IdiomaNombre, Fonetica.UsarHmuda, Fonetica.UsarUmuda, Fonetica.sistemafonetico)
'    Fonetica.FonApe1 = MotorFonetico_Convertir(frm!txtApe1, Fonetica.IdiomaApe1, Fonetica.UsarHmuda, Fonetica.UsarUmuda, Fonetica.sistemafonetico)
'    Fonetica.FonApe2 = MotorFonetico_Convertir(frm!txtApe2, Fonetica.IdiomaApe2, Fonetica.UsarHmuda, Fonetica.UsarUmuda, Fonetica.sistemafonetico)
'
'    ' --- Gestión ---
...
'
'    ' --- Modo ---
'    f.sistemafonetico = IIf(frm!chkModoFon, 1, 0)
'
'    ' --- Reglas ---
...
'
'    ' --- Modo ---
'    frm!chkModoFon = (f.sistemafonetico = 1)
'
'    ' --- Reglas ---
