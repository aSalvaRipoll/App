...
Public Sub MF_DebugDTO(Proc As String)
    ...
    strDebug = strDebug & vbCrLf
    strDebug = strDebug & vbCrLf & "SilabaTonica:          " & ObjDTO.SilabaTonica
    strDebug = strDebug & vbCrLf & "SilabaSecundaria:      " & ObjDTO.SilabaSecundaria
    strDebug = strDebug & vbCrLf
    strDebug = strDebug & vbCrLf & "TextoFinal (fonemas):  " & ObjDTO.TextoFinal
