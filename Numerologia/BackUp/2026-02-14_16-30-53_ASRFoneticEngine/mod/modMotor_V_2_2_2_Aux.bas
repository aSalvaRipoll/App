Attribute VB_Name = "modMotor_V_2_2_2_Aux"
'Option Compare Database
'Option Explicit
'
'' ------------------------------------------------------------
''   3.1.2.1- MARCAR TÓNICA
'' ------------------------------------------------------------
...
'
'' ------------------------------------------------------------
''   3.1.2.1- MARCAR SECUNDARIA
'' ------------------------------------------------------------
'Public Function MarcarSecundarias(ByVal silabas As String, ByVal secundarias As String) As String
'
'    Dim partes() As String
'    Dim idx() As String
'    Dim i As Long, j As Long
