Attribute VB_Name = "OLD_bas_Motor_ES_Main"
'' ============================================================
...
'
'    ' Í / Ú + fuerte
'    If v1 Like "[íú]" And EsVocalFuerte(v2) Then
'        EsHiato = True
'        Exit Function
'    End If
'
'    ' Fuerte + Í / Ú
'    If v2 Like "[íú]" And EsVocalFuerte(v1) Then
'        EsHiato = True
'        Exit Function
'    End If
'
...
'        s = Trim$(resultado(i))
'
'        ' Si es una sola consonante, la unimos con la siguiente sílaba real
'        If Len(s) = 1 Then
