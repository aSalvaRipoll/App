...
Sub MedirTiempoPreciso()
    ...
    'Entrada_Motor_ES ("José María Alfredo de la Concepción Cipriano Ignacio de la Santísima Trinidad Ruiz y Picasso")
    'Entrada_Motor_ES ("la amiga como él no es de Ana su hijo mi amigo pero eso lo oigo muy alto se oye")
