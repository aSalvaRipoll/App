...
''       REGLAS SILABEADOR
''=================================================================
'Private Function DebeCortar(ult As String, c As String, nextC As String, next2 As String, next3 As String, silaba As String) As Boolean
'
...
'
'If Regla_VCV(c, nextC, next2) Then GoTo cortar
...
'
'' === ÚLTIMA REGLA: CVC (CORRECTA) ===
'If Regla_CVC(c, nextC, next2, next3) Then GoTo cortar
'
'seguir:
'    DebeCortar = False
'    Exit Function
...
''If Regla_VC_SCC(ult, c, nextC, next2) Then GoTo cortar
''
''If Regla_CVC(ult, c, nextC, next2) Then GoTo cortar
''
''
''
''seguir:
...
'
'    addLog
'    addLog ("Inicio Regla_Hiato" & " --> " & ult & " - " & c & " - " & nextC)
'
'    If EsVocal(ult) And EsVocal(c) Then
'        If EsHiato(ult, c) Then Regla_Hiato = True
'    End If
'
'    addLog "Fin Regla_Hiato" & " >>> " & Regla_Hiato
'
'End Function
'
...
'
'    addLog
'    addLog "Inicio Regla_Diptongo" & " --> " & ult & " - " & c & " - " & nextC
'
'    If EsDiptongo(ult, c) Then Regla_Diptongo = True
'
'    addLog "Fin Regla_Diptongo" & " >>> " & Regla_Diptongo
'
'End Function
'
'Private Function Regla_VCV(v As String, c As String, nextV As String) As Boolean
'
'    addLog
'    addLog "Inicio Regla_VCV --> " & v & " - " & c & " - " & nextV
'
'    If EsVocal(v) And EsConsonante(c) And EsVocal(nextV) Then
'        Regla_VCV = True
'    End If
'
'    addLog "Fin Regla_VCV >>> " & Regla_VCV
'
'End Function
'
...
''
''    addLog
''    addLog "Inicio Regla_VCV" & " --> " & ult & " - " & c & " - " & nextC
''
...
''End Function
'
'Private Function Regla_CCV(c1 As String, c2 As String, v As String) As Boolean
'
'    addLog
'    addLog "Inicio Regla_CCV --> " & c1 & " - " & c2 & " - " & v
'
'    ' Solo CCV si c1+c2 es ataque complejo válido
'    Dim ataques
'    ataques = Array("pl", "pr", "bl", "br", "cl", "cr", "fl", "fr", "gl", "gr", "tr", "dr")
'
'    If EsConsonante(c1) And EsConsonante(c2) And EsVocal(v) Then
'        Dim a As Variant
...
'    End If
'
'    addLog "Fin Regla_CCV >>> " & Regla_CCV
'
'End Function
'
...
''
''    addLog
''    addLog "Inicio Regla_CCV" & " --> " & ult & " - " & c & " - " & nextC
''
...
'
'    addLog
'    addLog "Inicio Regla_NSP_NST" & " --> " & ult & " - " & c & " - " & nextC
'
...
'    End If
'
'    addLog "Fin Regla_NSP_NST" & " >>> " & Regla_NSP_NST
'
'End Function
'
...
'
'    addLog
'    addLog "Inicio Regla_SConsonante" & " --> " & ult & " - " & c & " - " & nextC
'
...
'    End If
'
'    addLog "Fin Regla_SConsonante" & " >>> " & Regla_SConsonante
'
'End Function
'
...
'
'    addLog
'    addLog "Inicio Regla_ClustersS" & " --> " & ult & " - " & c & " - " & nextC
'
'    Dim par As String
'    par = c & nextC
'
...
'    End If
'
'    addLog "Fin Regla_ClustersS" & " >>> " & Regla_ClustersS
'
'End Function
'
...
'
'    addLog
'    addLog "Inicio Regla_VocalTonica" & " --> " & ult & " - " & c & " - " & nextC
'
...
'    End If
'
'    addLog "Fin Regla_VocalTonica" & " >>> " & Regla_VocalTonica
'
'End Function
'
''Private Function Regla_VocalTonica(ult As String, c As String, nextC As String) As Boolean
...
''-----------------------------------------------------------------
'' C V C  ?  CVC (la consonante final se queda en la coda)
'Private Function Regla_CVC(c1 As String, v As String, c2 As String, nextChar As String) As Boolean
'
'    addLog
'    addLog "Inicio Regla_CVC --> " & c1 & " - " & v & " - " & c2 & " - " & nextChar
'
'    ' Patrón C V C + (NO vocal después)
'    If EsConsonante(c1) And EsVocal(v) And EsConsonante(c2) Then
'
'        ' Solo cerramos CVC si DESPUÉS de la C final
'        ' no viene una vocal (es decir, no puede ser ataque de la siguiente sílaba)
'        If Not EsVocal(nextChar) Then
'            Regla_CVC = True
'        End If
'
'    End If
'
'    addLog "Fin Regla_CVC >>> " & Regla_CVC
'
'End Function
'
''Private Function Regla_CVC(c1 As String, v As String, c2 As String, nextV As String) As Boolean
''
''    addLog
''    addLog "Inicio Regla_CVC --> " & c1 & " - " & v & " - " & c2 & " - " & nextV
''
''    ' Patrón C V C + vocal después
''    If EsConsonante(c1) And EsVocal(v) And EsConsonante(c2) And EsVocal(nextV) Then
''
''        ' La consonante final NO debe formar ataque complejo con la siguiente vocal
''        If Not EsGrupoInseparable(c2 & nextV) Then
''            Regla_CVC = True
''        End If
''
''    End If
...
'
'    addLog
'    addLog "Inicio Regla_VC_CCV" & " --> " & ult & " - " & c & " - " & nextC & " - " & next2
'
'    If EsVocal(ult) And EsConsonante(c) And EsConsonante(nextC) And EsVocal(next2) Then
'        ' Solo si CCV es ataque complejo
'        If Regla_CCV(c, nextC, next2) Then
'            Regla_VC_CCV = True
'        End If
'    End If
'
...
''    End If
'
'    addLog "Fin Regla_VC_CCV" & " >>> " & Regla_VC_CCV
'
'End Function
'
'' V C + S C V
...
'
'    addLog
'    addLog "Inicio Regla_VC_SCV" & " --> " & ult & " - " & c & " - " & nextC & " - " & next2
'
'    If EsVocal(ult) And EsConsonante(c) And nextC = "s" And EsConsonante(next2) Then
'        Regla_VC_SCV = True
'    End If
'
'    addLog "Fin Regla_VC_SCV" & " >>> " & Regla_VC_SCV
'
'End Function
'
'' V C + S + C
...
'
'    addLog
'    addLog "Inicio Regla_VC_SC" & " --> " & ult & " - " & c & " - " & nextC ' & " - " & next2
'
'    If EsVocal(ult) And EsConsonante(c) And nextC = "s" Then
'        Regla_VC_SC = True
'    End If
'
'    addLog "Fin Regla_VC_SC" & " >>> " & Regla_VC_SC
'
'End Function
'
'' V C + S + C + V
...
'
'    addLog
'    addLog "Inicio Regla_VC_SCV2" & " --> " & ult & " - " & c & " - " & nextC & " - " & next2
'
'    If EsVocal(ult) And EsConsonante(c) And nextC = "s" And EsConsonante(next2) Then
'        Regla_VC_SCV2 = True
'    End If
'
'    addLog "Fin Regla_VC_SCV2" & " >>> " & Regla_VC_SCV2
'
'End Function
'
''V C + S + C + C
...
'
'    addLog
'    addLog "Inicio Regla_VC_SCC" & " --> " & ult & " - " & c & " - " & nextC & " - " & next2
'
'    If EsVocal(ult) And EsConsonante(c) And nextC = "s" And EsConsonante(next2) Then
'        Regla_VC_SCC = True
'    End If
'
'    addLog "Fin Regla_VC_SCC" & " >>> " & Regla_VC_SCC
'
'End Function
'
...
'
'    addLog
'    addLog "Inicio Regla_Prefijos" & " --> " & silaba & " - " & c ' & " - " & nextC & " - " & next2
'
'    Dim prefijos
...
'    Next p
'
'    addLog "Fin Regla_Prefijos" & " >>> " & Regla_Prefijos
'
'End Function
'
'
...
'    Select Case par
'        Case "dr", "tr", "gr", "pr", "pl", "cl", "fr", "fl", "br", "bl", "cr"
