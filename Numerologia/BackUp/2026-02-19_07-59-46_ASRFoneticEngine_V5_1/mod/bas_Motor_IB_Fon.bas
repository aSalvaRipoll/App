...
' ============================================================
'   MOTOR FONÈTIC — BALEAR (IB)
'   Construcció d'IdsFonemes + IPA final
...
Public Sub ConstruirCadenaFonemas_IB()
    ...
    frase = NormalizarVocales_IB(ObjDTO.SilabasFinal)
...
' ============================================================
Private Sub ProcesarSilaba_IB(ByVal silabaCruda As String)
    ...
    Do While i <= Len(silaba)
        ...
        grafema = DetectarDigrafo_IB(silaba, i)
        ...
        ' 3. Fonema base IB
        id = AsignarFonemaBase_IB(grafema, sigCh, antCh)
...
' ============================================================
Private Function DetectarDigrafo_IB(t As String, pos As Long) As String
    ...
    If pos + 1 <= L Then
        ...
        Select Case par
            ...
            Case "ny": DetectarDigrafo_IB = par: Exit Function
            Case "ll": DetectarDigrafo_IB = par: Exit Function
            Case "rr": DetectarDigrafo_IB = par: Exit Function
            Case "ss": DetectarDigrafo_IB = par: Exit Function

            Case "tx": DetectarDigrafo_IB = par: Exit Function
            Case "tg", "tj": DetectarDigrafo_IB = par: Exit Function

            Case "ts", "tz": DetectarDigrafo_IB = par: Exit Function

            Case "ix": DetectarDigrafo_IB = par: Exit Function

            ' Qu / qü
            Case "qu": DetectarDigrafo_IB = par: Exit Function
            Case "qü": DetectarDigrafo_IB = par: Exit Function

            ' Gu / güe / güi
            Case "gu"
                If sig = "e" Or sig = "i" Then
                    DetectarDigrafo_IB = par
                    Exit Function
                End If
    ...
    If pos + 1 = L Then
        If Mid$(t, pos, 2) = "ig" Then
            DetectarDigrafo_IB = "tx"
            Exit Function
        End If
    End If

    ' 4. Si no és dígraf ? 1 lletra
    DetectarDigrafo_IB = Mid$(t, pos, 1)
...
' ============================================================
Private Function AsignarFonemaBase_IB(grafema As String, _
    ...
    ' VOCALS IB
    Select Case grafema
        Case "a", "à", "á": AsignarFonemaBase_IB = 1: Exit Function
        Case "e", "é": AsignarFonemaBase_IB = 2: Exit Function
        Case "è": AsignarFonemaBase_IB = 3: Exit Function
        Case "i", "í", "ï": AsignarFonemaBase_IB = 4: Exit Function
        Case "o", "ó": AsignarFonemaBase_IB = 5: Exit Function
        Case "ò": AsignarFonemaBase_IB = 6: Exit Function
        Case "u", "ú", "ü": AsignarFonemaBase_IB = 7: Exit Function
    End Select

    ' SEMIVOCALS
    If grafema = "j" Or grafema = "y" Then
        AsignarFonemaBase_IB = 21: Exit Function   ' /j/
    End If

    If grafema = "w" Then
        AsignarFonemaBase_IB = 22: Exit Function   ' /w/
    End If

    ' NASALS
    Select Case grafema
        Case "m": AsignarFonemaBase_IB = 36: Exit Function
        Case "n": AsignarFonemaBase_IB = 37: Exit Function
        Case "ny": AsignarFonemaBase_IB = 38: Exit Function
        Case "ng": AsignarFonemaBase_IB = 39: Exit Function
    End Select

    ' LATERALS
    If grafema = "l" Then AsignarFonemaBase_IB = 62: Exit Function
    If grafema = "ll" Then AsignarFonemaBase_IB = 63: Exit Function
    If grafema = "l·l" Then AsignarFonemaBase_IB = 63: Exit Function

    ' VIBRANTS
    If grafema = "rr" Then AsignarFonemaBase_IB = 60: Exit Function

    If grafema = "r" Then
        If ant = "" Or Not ant Like "[aeiouàèéíïòóúü]" Then
            AsignarFonemaBase_IB = 60   ' inicial / múltiple
        Else
            AsignarFonemaBase_IB = 59   ' intervocàlica
        End If
        Exit Function
    End If

    ' AFRICADES
    If grafema = "tx" Then AsignarFonemaBase_IB = 57: Exit Function
    If grafema = "tg" Or grafema = "tj" Then AsignarFonemaBase_IB = 58: Exit Function
    If grafema = "ts" Or grafema = "tz" Then AsignarFonemaBase_IB = 46: Exit Function

    ' FRICATIVES
    If grafema = "s" Then AsignarFonemaBase_IB = 42: Exit Function
    If grafema = "z" Then AsignarFonemaBase_IB = 43: Exit Function
    If grafema = "x" Then AsignarFonemaBase_IB = 44: Exit Function
    If grafema = "ix" Then AsignarFonemaBase_IB = 44: Exit Function
    If grafema = "j" Then AsignarFonemaBase_IB = 45: Exit Function
    If grafema = "ge" Or grafema = "gi" Then AsignarFonemaBase_IB = 45: Exit Function

    ' OCLUSIVES
    Select Case grafema
        Case "v": AsignarFonemaBase_IB = 41: Exit Function
        Case "p": AsignarFonemaBase_IB = 30: Exit Function
        Case "b": AsignarFonemaBase_IB = 31: Exit Function
        Case "t": AsignarFonemaBase_IB = 32: Exit Function
        Case "d": AsignarFonemaBase_IB = 33: Exit Function
        Case "c", "k", "qu": AsignarFonemaBase_IB = 34: Exit Function
        Case "g", "gu": AsignarFonemaBase_IB = 35: Exit Function
    End Select

    ' No reconegut ? 255
    AsignarFonemaBase_IB = 255
...
' ============================================================
Private Function NormalizarVocales_IB(ByVal texto As String) As String
    NormalizarVocales_IB = texto
End Function
