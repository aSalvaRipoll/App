...
'   VERSIÓN CASTELLANO (ESPAÑOL GENERAL)
'
...
Private Function DetectarPrefijo_ES(ByVal t As String) As String
    ...
    If Not prefijosCargados_ES Then DetectarPrefijo_ES

    For Each p In prefijosEstrictos_ES
        ...
        If p = "a" Then
            ...
            If Not EsVocal_ES(primera) Then
                GoTo SiguienteP
            End If

            ' 2.2) No puede romper un diptongo
            If EsDiptongo_ES(Left$(t, 1), Mid$(t, 2, 1)) Then
                GoTo SiguienteP
            End If
