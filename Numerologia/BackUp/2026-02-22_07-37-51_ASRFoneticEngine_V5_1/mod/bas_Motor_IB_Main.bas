...
Private Function DetectarPrefijo_IB(ByVal t As String) As String
    ...
    For Each p In prefijosEstrictos_IB
        ...
        If p = "a" Then
            ...
            If Not EsVocal_IB(primera) Then
                GoTo SiguienteP
            End If

            ' 2.2) No puede romper un diptongo
            If EsDiptongo_IB(Left$(t, 1), Mid$(t, 2, 1)) Then
                GoTo SiguienteP
            End If
    ...
    Do While i <= L
        ...
        If EsVocal_IB(c1) Then
            ...
            If i + 2 <= L Then
                c2 = Mid$(t, i + 1, 1)
                c3 = Mid$(t, i + 2, 1)
                If EsTriptongo_IB(c1, c2, c3) Then
                    nNuc = nNuc + 1
                    nucIni(nNuc) = i
                    nucFin(nNuc) = i + 2
                    If DebugMotor Then
...
Private Function EsVocalDebilTonica_IB(ByVal c As String) As Boolean
    EsVocalDebilTonica_IB = InStr("íú", LCase$(c)) > 0
End Function

Private Function EsVocalDebil_IB(ByVal c As String) As Boolean
    EsVocalDebil_IB = InStr("iíïuúü", LCase$(c)) > 0
End Function
...
Private Function EsTriptongo_IB(ByVal v1 As String, ByVal v2 As String, ByVal v3 As String) As Boolean
    If EsVocalDebil_IB(v1) And Not EsVocalDebilTonica_IB(v1) _
       And EsVocalFuerte_IB(v2) _
       And EsVocalDebil_IB(v3) And Not EsVocalDebilTonica_IB(v3) Then
        EsTriptongo_IB = True
    End If
End Function
