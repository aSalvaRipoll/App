...
' ============================================================
Function EsVocal(c As String) As Boolean
    Select Case c
        Case "a", "à", "á", _
             "e", "è", "é", _
             "i", "í", "ï", _
...
Function EsVocalFuerte(c As String) As Boolean
    Select Case c
        Case "a", "à", "á", _
             "e", "è", "é", _
             "o", "ò", "ó"
...
Function EsSemivocal(c As String) As Boolean
    Select Case c
        Case "i", "í", "ï", _
             "u", "ú", "ü"
            EsSemivocal = True
...
Function EsDiptongo(c1 As String, c2 As String) As Boolean
    Dim par As String
    par = c1 & c2
