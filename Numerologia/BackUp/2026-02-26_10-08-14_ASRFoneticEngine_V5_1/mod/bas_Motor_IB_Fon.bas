...
'
'
'        ' --- Schwa IB (només proclítics i apòcope) ---
'        If esAtona Then
...
'            End If
'
''            ' --- QU / QÜ (solo si va seguido de e o i) ---
''            If par = "qu" Then
''                If pos + 2 <= L Then
''                    sig = Mid$(t, pos + 2, 1)
''                    If sig = "e" Or sig = "i" Or sig = "é" Or sig = "è" Then
''                        DetectarDigrafo = par
''                        Exit Function
''                    End If
''                End If
...
'            End If
'
'' 3) GU + e/i ? NO dígraf (mallorquí)
''    ? se procesará como "g" + "e/i" ? /?/
'
''            Case "gu"
...
'
'    ' --- GU / GÜ mallorquí: fonema doble /g/ + /w/ ---
'    If grafema = "gu" Then
'        ' gu + a/o/u ? /g/ + /w/
'        If sig Like "[aouàòóú]" Then
...
'
'    cadena = Replace(cadena, "34 2", "42 2") ' ce ? se
'    cadena = Replace(cadena, "34 4", "42 4") ' ci ? si
'
'    cadena = Replace(cadena, "35 2", "45 2")
'    cadena = Replace(cadena, "35 4", "45 4")
'
'    If Right$(cadena, 2) = "59" Then
...
'    End If
'
'    cadena = Replace(cadena, "7 37", "7 39") ' u + n ? u + ?
'
