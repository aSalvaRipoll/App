...
'        ' ============================================================
'        '   REGLA EX ? /eks/ o /e?/ segons la síl·laba següent
'        ' ============================================================
'        If grafema = "x" And antCh = "e" Then
'
'            Dim arr As Variant
...
'
'                If Len(sigSil) >= 1 Then primera = Left$(sigSil, 1)
'                If Len(sigSil) >= 2 Then segona = Mid$(sigSil, 2, 1)
'
'                ' EXTRA- ? /ekstr/
'                If primera = "t" Or primera = "r" Then
...
'
'                ' EX + consonant ? /eks/
'                If primera Like "[bcdfghjklmnpqrstvwxyz]" Then
'                    ObjDTO.IdsFonemas = ObjDTO.IdsFonemas & "34,42,"
'                    i = i + 1
'                    GoTo SegGraf
'                End If
'
'                ' EX + vocal + consonant (exactament) ? /eks/
'                If primera Like "[aeiouàèéíïòóúü]" And segona Like "[bcdfghjklmnpqrstvwxyz]" Then
'                    ObjDTO.IdsFonemas = ObjDTO.IdsFonemas & "34,42,"
'                    i = i + 1
'                    GoTo SegGraf
'                End If
...
'
'        ' ============================================================
'        '   REGLAS MALLORQUINAS (las 6 que faltaban)
'        ' ============================================================
'
'' 1) QU + A/O/U ? /kw/
'If grafema = "qu" Then
...
'    If sigCh Like "[eéiíè]" Then
'        ObjDTO.IdsFonemas = ObjDTO.IdsFonemas & "35,22," & AsignarFonemaBase(sigCh) & ","
'        i = i + 3   ' g + ü + vocal  (aquí tenías i + 2)
'        GoTo SegGraf
'    End If
'End If
'
...
'
'        ' ============================================================
'        '   RESTO DE CASOS ESPECIALES (ya estaban bien)
'        ' ============================================================
'
'        ' GU + A/O/U ? /gw/
'        If grafema = "gu" Then
