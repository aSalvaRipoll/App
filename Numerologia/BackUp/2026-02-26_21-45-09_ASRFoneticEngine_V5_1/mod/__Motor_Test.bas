...
'    'SilabearFrase ("Pablo Diego José Francisco de Paula Juan Nepomuceno María de los Remedios Cipriano de la Santísima Trinidad Ruiz y Picasso")
    ...
    Entrada_Motor_VA ("extra, extraordinari, extrem, explicar, exsudar, exrei extra, exsudar, exculpar, exclamar, exrei, exvotar  exhumar")
...
' -----------------------------------------------
    ...
    If DebugDTO Then
        Call MF_DebugDTO("Motor VA revisado")
    End If
