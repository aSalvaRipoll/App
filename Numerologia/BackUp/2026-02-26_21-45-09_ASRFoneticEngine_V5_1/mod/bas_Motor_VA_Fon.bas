...
'        ' ============================================================
'        '   *** BLOQUE EX- (1): CUANDO LA SÍLABA ES "ex" ***
'        '   Este bloque cubre: extra, extrem, explicar, exsudar,
'        '   exrei, exculpar, exclamar, exvotar, exhumar, etc.
'        ' ============================================================
'        If grafema = "ex" Then
'
'            Dim arr1 As Variant
...
'
'                ' Primera letra real de la sílaba siguiente
'                If Len(silSig1) >= 1 Then primera1 = LCase$(Left$(silSig1, 1)) Else primera1 = ""
'
'                ' Segunda letra (consonante del radical)
'                If Len(silSig1) >= 2 Then consonant1 = LCase$(Mid$(silSig1, 2, 1)) Else consonant1 = ""
'
'                ' ex + vocal ? /ez/
'                If primera1 Like "[aeiouàèéíïòóúü]" Then
'                    ObjDTO.IdsFonemas = ObjDTO.IdsFonemas & "43,"   ' z
...
'
'        ' ============================================================
'        '   *** BLOQUE EX- (2): CUANDO LA SÍLABA ES "xa/xi/xo/xac..." ***
'        '   Este bloque cubre: examen, exili, exonerar, exacte,
'        '   exagerar, eximir, etc.
'        ' ============================================================
'        If Left$(grafema, 1) = "x" Then
'
...
'                        If Len(silSig) >= 3 Then consonant = LCase$(Mid$(silSig, 3, 1)) Else consonant = ""
'
'                        ' ex + vocal ? /ez/
'                        If primera Like "[aeiouàèéíïòóúü]" Then
'                            ObjDTO.IdsFonemas = ObjDTO.IdsFonemas & "43,"
...
'        End If
'
'        ' 3. Apertura vocálica valenciana real (e/o tónicas)
'        If esTonica Then
'            If grafema = "e" Then
'                id = 3   ' /?/
'                GoTo Agregar
...
'
'        ' ============================================================
'        '   REGLA EX- VALENCIANA (normativa estricta A1)
'        '   Detectada mirant la síl·laba anterior real
'        ' ============================================================
'        If Left$(grafema, 1) = "x" Then
'
'            Dim arr As Variant
...
'            Dim consonant As String
'
'            ' Obtenir array de síl·labes finals
'            arr = Split(ObjDTO.SilabasFinal, "|")
'
...
'                silAnt = Trim$(silAnt)
'
'                ' Prefix EX- si la síl·laba anterior acaba en "e"
'                If Right$(silAnt, 1) = "e" Then
'
'                    ' Síl·laba següent real
'                    silSig = BuscarSilabaRealPosterior(arr, idx)
'                    If silSig <> "" Then
'
'                        silSig = Replace(silSig, "(", "")
...
'                        silSig = Trim$(silSig)
'
'                        ' Primera lletra després de la x
'                        If Len(silSig) >= 2 Then
'                            primera = LCase$(Mid$(silSig, 2, 1))
'                        Else
'                            primera = ""
'                        End If
'
'                        ' Segona lletra després de la vocal (consonant real)
'                        If Len(silSig) >= 3 Then
'                            consonant = LCase$(Mid$(silSig, 3, 1))
'                        Else
'                            consonant = ""
'                        End If
'
...
'
'                ' IMPORTANT:
'                ' Primera lletra REAL després de la "x"
'                If Len(silSig) >= 2 Then
'                    primera = LCase$(Mid$(silSig, 2, 1))
'                Else
'                    primera = ""
...
''                        silSig = Trim$(silSig)
''
''                        ' Detectar el primer grafema real de la síl·laba següent
''                        grafSig = DetectarDigrafo(silSig, 1)
''                        primera = LCase$(Left$(grafSig, 1))
''
''                        ' ex + vocal ? /ez/
''                        If primera Like "[aeiouàèéíïòóúü]" Then
''                            ObjDTO.IdsFonemas = ObjDTO.IdsFonemas & "43,"   ' z
...
''                        silSig = Trim$(silSig)
''
''                        If Len(silSig) >= 1 Then primera = LCase$(Left$(silSig, 1)) Else primera = ""
''
''                        ' ex + vocal ? /ez/
''                        If primera Like "[aeiouàèéíïòóúü]" Then
''                            ObjDTO.IdsFonemas = ObjDTO.IdsFonemas & "43,"   ' z
...
'
'        ' ============================================================
'        '   REGLA EX- VALENCIANA (normativa estricta)
'        '   ex + vocal        ? /ez/   (x ? 43)
'        '   ex + consonant sonora ? /egz/ (x ? 35,43)
'        '   ex + consonant sorda  ? /eks/ (x ? 34,42)
'        '   ex + t           ? /ekst/ (x ? 34,42,32)
'        '   ex + r           ? /eksr/ (x ? 34,42,60)
'        ' ============================================================
...
'                ' ex + r ? /eksr/
'                If primera = "r" Then
'                    ObjDTO.IdsFonemas = ObjDTO.IdsFonemas & "34,42,60,"   ' k s r (forta)
'                    i = i + 1
'                    GoTo SegGraf
'                End If
'
