...
Private Function AtaqueSilabicoValido(ByVal a As String, ByVal b As String) As Boolean
    ...
    ' ?? Parche EX- : impedir que "x" inicie sílaba si va precedida de "e"
    If a = "x" And b <> "" Then
...
Private Sub CalcularSilabas(ByVal t As String, _
    ...
    For i = 1 To nNuc - 1
        ...
        Select Case k
            ...
            Case 1
            ' ?? Parche EX- para k = 1 consonante
If Mid$(t, a, 1) = "e" And Mid$(t, a + 1, 1) = "x" Then
    ' Forzar cierre antes de la x ? ex | a
    silFin(i) = a + 1
    silIni(i + 1) = a + 2
    GoTo siguiente
End If
