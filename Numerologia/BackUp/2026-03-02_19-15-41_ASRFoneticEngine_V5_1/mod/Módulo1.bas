...
'
'' ============================================================
''   MOTOR DE SILABEO 5.0 — ORTOGRÁFICO + MORFOSILÁBICO + ACENTUACIÓN
''   VERSIÓN PORTUGUÉS EUROPEO (PT-EU)
''
''   Autor: Alba Salvá Ripoll
''
''   Basado en el motor GL, adaptado a:
''       ? Vocales portuguesas (á, é, í, ó, ú, â, ê, ô, ã, õ)
''       ? Diptongos portugueses (ai, ei, oi, ui, au, eu, ou, ão, õe, ãe…)
''       ? Triptongos portugueses (uai, uei, uão…)
''       ? Nasalización ortográfica (m/n final, til)
''       ? Dígrafos portugueses (nh, lh, ch, rr)
''       ? Ataques portugueses (vr, vl, ps, pn, mn, gn)
''       ? Reglas de acentuación PT-EU
''
'' ============================================================
'
...
'
'' ============================================================
''   ENTRADA PRINCIPAL DEL MOTOR PT-EU
'' ============================================================
'
...
'
'' ============================================================
''   CÁLCULO DE FRONTERAS SILÁBICAS PT-EU
'' ============================================================
'
...
'    Next i
'
'    If TerminaEnVocalNSM(palabra) Then
...
'
'' ============================================================
''   TERMINA EN VOCAL / N / S / M  (PORTUGUÉS EUROPEO)
'' ============================================================
'' En portugués:
''   - Palabras terminadas en vocal ? paroxítonas
''   - Terminadas en -n ? nasal, pero se comporta como vocal para acentuación
''   - Terminadas en -m ? nasal, pero se comporta como vocal para acentuación
''   - Terminadas en -s ? plural ? paroxítonas
''
''   Ejemplos:
''       "homem" ? ho-mem ? tónica en la penúltima
''       "homens" ? ho-mens ? tónica en la penúltima
''       "canto" ? can-to ? tónica en la penúltima
''
...
'
'' ============================================================
''   DETECTAR SÍLABAS TÓNICAS (PT-EU)
'' ============================================================
'' Reglas:
''   1) Si hay tilde ? esa sílaba es tónica
''   2) Si NO hay tilde:
''       - Si termina en vocal / n / s / m ? penúltima
''       - Si termina en otra consonante ? última
''
...
'    Next i
'
'    ' 2) Sin tilde ? reglas generales PT-EU
...
'
'' ============================================================
''   DETECTAR SECUNDARIAS (idéntico a GL)
'' ============================================================
...
'    secs.Add 1
'
'    ' Segunda secundaria en palabras largas
'    If n >= 6 Then
'        pos2 = tPos - 2
...
'
'' ============================================================
''   STUB FONÉTICO (se implementa en otro módulo)
'' ============================================================
'Public Sub ConstruirCadenaFonemas_PT()
'    ' Aquí irá el motor fonético PT-EU
'    ' El silabeo ya está completo
'End Sub
