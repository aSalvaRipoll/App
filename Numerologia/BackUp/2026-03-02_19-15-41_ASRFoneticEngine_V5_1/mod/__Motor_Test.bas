...
'    PreferirIlLu = True
    ...
    'Entrada_Motor_ES ("Marco Aurelio") ' Ignacio Ezequiel")
    'Entrada_Motor_ES ("Marco Ezequiel")
    
    motor = "CA"
    'Entrada_Motor_CA ("Eulàlia Güell-i-Ferreró-Montjuïc")
    'Entrada_Motor_CA ("terra Germà Gerra braç gràcia cor")
    'Entrada_Motor_CA ("metge fetge cotxe puig boig maig")
    ...
    'Entrada_Motor_IB ("exalçar-se")
    
    
    'motor = "VA"
    'Entrada_Motor_VA ("Ausiàs Benimacletixotxa Almenarbrell")
    
    'Entrada_Motor_VA ("examen, exili, exonerar, exacte, exagerar, eximir extra, extraordinari, extrem, explicar, exsudar, exrei extra, exsudar, exculpar, exclamar, exrei, exvotar  exhumar")
    'Entrada_Motor_VA ("extra, extraordinari, extrem, explicar, exsudar, exculpar, exclamar, exvotar  exhumar exrei")
    'Entrada_Motor_VA ("extra extraordinari extraordinària extraordinàriament extracció extracte extractor extradir extradició extramurs extramarital extraterritorial " & _
                      "extraviat extraviar extralimitació extralingüístic")
    'Entrada_Motor_VA ("extrem extremar extremista extremitat extremadament extreure extrèmic extrínsec extrusió extrusor extròpic")
    'Entrada_Motor_VA ("explicar exculpar exclamar excloure exsudar exsangüe exsolució extemporani extenuar extens extensió extensible extinció extingir extirpar")
    'Entrada_Motor_VA ("exvotar exhumar eximir exigir exiliar exonerar exoneració exonerat exonerable")
    'Entrada_Motor_VA ("exaltar exalçar exalçar-se exalçar-lo exalçar-nos exalçar-vos exalçar-se’n exalçar-hi exalçar-ho exalçar-la exalçar-les exalçar-los exalçar-me exalçar-te exalçar-vos-en")
    'Entrada_Motor_VA ("donar-me’l-hi portar-vos-en-lo menjar-se’n-la exalçar-vos-en")
    ...
    'Entrada_Motor_GL ("ghrande ghato ghañido ghoular ghrileira ghrandeza ghraduación ghrilexar aíghoa trebigho amigho fighueira lighoira carregho reghueifa trigho arghuela")
    'Entrada_Motor_GL ("ghuindastre ghueira ghoiante ghoia reghoada reghoío reghoído ghuión")
    'Entrada_Motor_GL ("aínda aéreo xeografía poesía baía proaíña noaía maieuta saúde caída transxénico inmellorable desxeo esguello esgrevio esguío esguizar esgrima esguello escaravello")
    'Entrada_Motor_GL ("xanxullo xanxuar xanxueira xanxón xanxiña cailleira cailleiro follón follente follada carballal carballeiro carballoada camiñoira camiñoeiro camiñeiro camiñenta camiñeiroa camiñaría")
    'Entrada_Motor_GL ("contraataqueiro reghueifaría desxeoconxelado antighaiteiro superxenética hiperrealismo microxeoloxía macroxeografía ultramarinhía")
    'Entrada_Motor_GL ("O ghato de Ghuimarei reghou na reghueira da casa vella.")
    'Entrada_Motor_GL ("Aínda que a reghoada caeu, a reghueira segue seca.")
    'Entrada_Motor_GL ("A fighueira da horta medra á beira da reghueira fonda.")
    'Entrada_Motor_GL ("O amigho de Oia trouxo unha reghueifa moi boa.")
    'Entrada_Motor_GL ("Aínda hoxe a ghente de Ghuísamo fala coa gheada.")
    'Entrada_Motor_GL ("ghüei, ghüi, ghüa, ghüía, ghüo")
    
    motor = "PT"
    'Entrada_Motor_PT ("pão mãe põe cães limões capitães")
    'Entrada_Motor_PT ("canto venda tinta ponto mundo falam cantam comem sabem fazem campeão")
    'Entrada_Motor_PT ("falam cantam  comem sabem fazem campeão")
    'Entrada_Motor_PT ("irmã irmãzinha manhã amanhã romã bem tem som fim bom")
    'Entrada_Motor_PT ("exame exato texto próximo táxi peixe leite caixa ouro pai")
    'Entrada_Motor_PT ("casa sapo massa coisa nós carro rua ferro caro raro")
    'Entrada_Motor_PT ("     interessante                           responsabilidade             comunicação pensamento                     desenvolvimento              ")
    'Entrada_Motor_PT ("tóxico fixar tórax sexo")
    'Entrada_Motor_PT ("exagerar exemplo exigir exuberant")
    Entrada_Motor_PT ("rato caro prato cravo mar porta")
    'Entrada_Motor_PT ("pão")
    'Entrada_Motor_PT ("pão")
...
' -----------------------------------------------
    ...
    If DebugDTO Then
        Call MF_DebugDTO("Motor " & motor & " revisado")
    End If
