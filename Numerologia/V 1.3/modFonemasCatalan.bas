...
Public Function ObtenerFonemasCatalan(ByVal nombre As String, Optional ByVal UsarHmuda As Boolean = True) ', Optional ByVal UsarUmuda As Boolean = True) As String ' Collection
    ...
    Do While i <= Len(txt)
        ...
        f = ExtraerFonema(txt, i, UsarHmuda)
        If f <> "" Then
            'col.Add f
            Out = Out & f
        End If
...
Private Function ExtraerFonema(ByVal txt As String, ByRef i As Long, ByVal UsarHmuda As Boolean) As String
'Private Function ExtraerFonema(ByVal txt As String, ByRef i As Long, ByVal UsarHmuda As Boolean, ByVal UsarUmuda As Boolean) As String
