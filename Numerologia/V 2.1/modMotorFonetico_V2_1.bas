...
Public Function ConvertirGrafemaAIdFonema( _
    ...
    Select Case LCase$(idioma)
        ...
        Case "en":      ConvertirGrafemaAIdFonema = ReglasIngles(graf, ant, sig, False)
...
'
'    Select Case idioma
'        Case "ESP": ConvertirGrafemaAIdFonema = ReglasCastellano(graf, ant, sig, False)
'        Case "CAT": ConvertirGrafemaAIdFonema = ReglasCatala(graf, ant, sig, False)
'        Case "MLL": ConvertirGrafemaAIdFonema = ReglasMallorquin(graf, ant, sig, False)
'        Case "VAL": ConvertirGrafemaAIdFonema = ReglasValenciano(graf, ant, sig, False)
'        Case "EUS": ConvertirGrafemaAIdFonema = ReglasEuskera(graf, ant, sig, False)
'        Case "GAL": ConvertirGrafemaAIdFonema = ReglasGalego(graf, ant, sig, False)
'        Case "POR": ConvertirGrafemaAIdFonema = ReglasPortugues(graf, ant, sig, False)
'        Case "FRA": ConvertirGrafemaAIdFonema = ReglasFrances(graf, ant, sig, False)
'        Case "ENG": ConvertirGrafemaAIdFonema = ReglasIngles(graf, ant, sig, False)
'        Case Else:  ConvertirGrafemaAIdFonema = 0
'    End Select
'
'End Function
...
'
'        Select Case tri
'            ' Trígrafos universales
'            Case "GÜE", "GÜI", "GUE", "GUI", "QUE", "QUI"
'                SiguienteGrafema = tri
'                Exit Function
'
'            ' Trígrafos franceses/portugueses
'            Case "AIN", "EIN", "EIM"
'                SiguienteGrafema = tri
'                Exit Function
'        End Select
...
'        Select Case di
'
'            ' --- Dígrafos fonéticos comunes ---
'            Case "CH", "LL", "RR", "NY", "GN", "NH", "LH", _
'                 "TX", "TS", "TZ", "SS", "PH", "SH", "TH", "DH", "WH"
'                SiguienteGrafema = di
'                Exit Function
'
'            ' --- Ela geminada ---
'            Case "L·", "L."
'                ' Permitimos capturar L·L como dígrafo + monógrafo
'                SiguienteGrafema = di
'                Exit Function
'
'            ' --- Diptongos universales ---
'            Case "AI", "EI", "OI", "OU", "AU", "EU", "UI", _
'                 "AY", "OY", "AW", "OW", "EA", "EE", "IE"
'
'                SiguienteGrafema = di
'                Exit Function
'
'            ' --- Nasales PT/FR ---
'            Case "AN", "AM", "EN", "EM", "IN", "IM", _
'                 "ON", "OM", "UN", "UM", "YN", "YM", "ÃO"
'
'                SiguienteGrafema = di
'                Exit Function
'
...
'
'        Select Case tri
'            Case "GÜE", "GÜI", "GUE", "GUI", "QUE", "QUI", _
'                 "AIN", "EIN", "EIM" ' francés/portugués
'                SiguienteGrafema = tri
'                Exit Function
'        End Select
'    End If
...
'        Select Case di
'            ' comunes
'            Case "CH", "LL", "RR", "NH", "LH", "GN", "NY", "TX", "TS", "TZ", "SS", "PH", "SH", "TH", "DH", "WH"
'                SiguienteGrafema = di
'                Exit Function
'            ' vocales/diptongos
'            Case "AI", "EI", "OI", "OU", "AU", "EU", "UI", "AY", "OY", "AW", "OW", "EA", "EE", "IE", "OI"
'                SiguienteGrafema = di
'                Exit Function
'            ' nasales PT/FR
'            Case "AN", "AM", "EN", "EM", "IN", "IM", "ON", "OM", "UN", "UM", "YM", "YN", "ÃO"
'                SiguienteGrafema = di
'                Exit Function
'            ' ela geminada
'            Case "L·", "L."
'                ' lo dejamos como L·L en las reglas, pero aquí cogemos solo L·
'        End Select
'    End If
'
'    ' Monógrafo
...
'Public Function ConvertirNombreAParGrafemaASCII( _
'        ByVal NombreOriginal As String, _
'        ByVal Idioma As String _
'    ) As Collection
'
...
'    i = 1
'
'    Do While i <= Len(NombreOriginal)
'
'        '-----------------------------------------
'        ' 1) Intentar TRIGRAFEMA (3 letras)
'        '-----------------------------------------
'        If i <= Len(NombreOriginal) - 2 Then
'            graf = Mid(NombreOriginal, i, 3)
'            ascii = ConvertirGrafemaAASCII(graf, Idioma)
'
'            If ascii <> "" Then
'                Set p = New clsParGrafemaASCII
'                p.GrafemaOriginal = graf
'                p.ascii = ascii
'                p.NumOrden = NumOrden
'                col.Add p
'
...
'
'        '-----------------------------------------
'        ' 2) Intentar DÍGRAFO (2 letras)
'        '-----------------------------------------
'        If i <= Len(NombreOriginal) - 1 Then
'            graf = Mid(NombreOriginal, i, 2)
'            ascii = ConvertirGrafemaAASCII(graf, Idioma)
'
'            If ascii <> "" Then
'                Set p = New clsParGrafemaASCII
...
'    Loop
'
'    Set ConvertirNombreAParGrafemaASCII = col
'End Function
'
'Private Function ConvertirGrafemaAASCII( _
'        ByVal graf As String, _
'        ByVal Idioma As String _
'    ) As String
'
...
'
'    '-----------------------------------------
'    ' EJEMPLOS DE REGLAS (añadiremos más)
'    '-----------------------------------------
'
'    ' Catalán / Euskera / Español
'    Select Case graf
'        Case "tx": ConvertirGrafemaAASCII = "CH"
'        Case "tz": ConvertirGrafemaAASCII = "TS"
'        Case "ts": ConvertirGrafemaAASCII = "TS"
'        Case "ny", "nh": ConvertirGrafemaAASCII = "NY"
'        Case "ll": ConvertirGrafemaAASCII = "LY"
'        Case "l·l": ConvertirGrafemaAASCII = "LL_GEM"
'        Case "ch": ConvertirGrafemaAASCII = "CH"
'        Case "sh": ConvertirGrafemaAASCII = "SH"
'
'        ' Vocales especiales
'        Case "ou": ConvertirGrafemaAASCII = "U"   ' Lourdes ? LURDES
'        Case "au": ConvertirGrafemaAASCII = "O"
'
'        ' Monógrafos
'        Case "a": ConvertirGrafemaAASCII = "A"
'        Case "e": ConvertirGrafemaAASCII = "E"
'        Case "i": ConvertirGrafemaAASCII = "I"
'        Case "o": ConvertirGrafemaAASCII = "O"
'        Case "u": ConvertirGrafemaAASCII = "U"
'
'        Case "b": ConvertirGrafemaAASCII = "B"
'        Case "c": ConvertirGrafemaAASCII = "C"   ' luego se resolverá según contexto
'        Case "d": ConvertirGrafemaAASCII = "D"
'        Case "f": ConvertirGrafemaAASCII = "F"
'        Case "g": ConvertirGrafemaAASCII = "G"
'        Case "l": ConvertirGrafemaAASCII = "L"
'        Case "m": ConvertirGrafemaAASCII = "M"
'        Case "n": ConvertirGrafemaAASCII = "N"
'        Case "p": ConvertirGrafemaAASCII = "P"
'        Case "r": ConvertirGrafemaAASCII = "R"
'        Case "s": ConvertirGrafemaAASCII = "S"
'        Case "t": ConvertirGrafemaAASCII = "T"
'        Case "x": ConvertirGrafemaAASCII = "X"
'
'        Case Else
'            ConvertirGrafemaAASCII = ""
'    End Select
'
'End Function
