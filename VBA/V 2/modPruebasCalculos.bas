...
Private Sub PruebaCiclos(ByVal fecha As Date)
    ...
    Set obj3 = New clsCalculoCiclo4
    obj3.FechaNacimiento = fecha
    Debug.Print "Ciclo 4: " & obj4.Calcular() & " (" & obj4.ObtenerRangoEdades() & ")"
...
Private Sub PruebaNumeroEspeciales(ByVal nombre As String)
    ...
    Dim objPrimeraConsonante As clsCalculoPrimeraConsonante
    ...
    Set objPrimeraLetra = New clsCalculoPrimeraVocal
    objPrimeraLetra.NombreCompleto = nombre
    Debug.Print "Primera Letra: " & objPrimeraVical.Calcular() & " (" & objPrimeraVocal.PrimeraVocal & ")"
